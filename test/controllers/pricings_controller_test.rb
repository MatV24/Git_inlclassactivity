...
class PricingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pricing" do
    assert_difference('Pricing.count') do
      post pricings_url, params: { pricing: { price: @pricing.price, product_id: @pricing.product_id, quantitydiscount: @pricing.quantitydiscount, vendor_id: @pricing.vendor_id } }
    end
  ...
  test "should update pricing" do
    patch pricing_url(@pricing), params: { pricing: { price: @pricing.price, product_id: @pricing.product_id, quantitydiscount: @pricing.quantitydiscount, vendor_id: @pricing.vendor_id } }
